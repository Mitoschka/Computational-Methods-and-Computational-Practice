...
def сompound_quadrature_formula_of_left_rect(f, a, b, n, h, have_derivative):
    sum = 0
    return_value = None
    m = 0
...
# АСТ 0
def сompound_quadrature_formula_of_right_rect(f, a, b, n, h, have_derivative):
    sum = 0
    return_value = None
    m = 0
...
# АСТ 1
def сompound_quadrature_formula_of_inter_rect(f, a, b, n, h, have_derivative):
    sum = 0
    return_value = None
    m = 0
...
# АСТ 1
def сompound_quadrature_formula_of_trap(f, a, b, n, h, have_derivative):
    sum = 0
    return_value = None
    m = 0
...
# АСТ 3
def сompound_quadrature_formula_of_simp(f, a, b, n, h, have_derivative):
    sum = 0
    return_value = None
    m = 0
...
# АСТ 3
def сompound_quadrature_formula_of_3_8(f, a, b, n, h, have_derivative):
    sum = 0
    return_value = None
    m = 0
